...
async function main() {
  ...
  const profiles = [
    { systemName: 'ALUPCO SG — سحاب', systemType: 'SLIDING' as const, frameToSashHorizontal: 42, frameToSashVertical: 50, mullionDeduction: 90, transomDeduction: 90, overlapAllowance: 30, glassDeductionHorizontal: 110, glassDeductionVertical: 110 },
    { systemName: 'Saraya 10cm — سحاب', systemType: 'SLIDING' as const, frameToSashHorizontal: 45, frameToSashVertical: 52, mullionDeduction: 95, transomDeduction: 95, overlapAllowance: 32, glassDeductionHorizontal: 112, glassDeductionVertical: 112 },
    { systemName: 'Technal — مفصلي', systemType: 'HINGED' as const, frameToSashHorizontal: 24, frameToSashVertical: 24, mullionDeduction: 80, transomDeduction: 80, overlapAllowance: 0, glassDeductionHorizontal: 95, glassDeductionVertical: 95 },
    { systemName: 'Schuco AWS — مفصلي', systemType: 'HINGED' as const, frameToSashHorizontal: 22, frameToSashVertical: 22, mullionDeduction: 78, transomDeduction: 78, overlapAllowance: 0, glassDeductionHorizontal: 92, glassDeductionVertical: 92 },
    { systemName: 'Reynaers CW 50 — واجهات', systemType: 'CURTAIN_WALL' as const, frameToSashHorizontal: 0, frameToSashVertical: 0, mullionDeduction: 50, transomDeduction: 50, overlapAllowance: 0, glassDeductionHorizontal: 12, glassDeductionVertical: 12 },
  ];
