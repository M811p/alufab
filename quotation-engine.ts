...
export const SAUDI_VAT_RATE = 0.15; // ضريبة القيمة المضافة 15% — لائحة هيئة الزكاة والضريبة والجمارك
...
export class QuotationEngine {
  public static calculateBill(input: QuotationInput): QuotationBill {
    ...
    // ⚠️ تم إصلاح خطأ سابق: كان يستخدم Number(x.toLocaleString()) مما ينتج NaN
  ...
  /** تنسيق للعرض فقط — يبقى الرقم الخام في QuotationBill للحسابات */
