...
/**
 * ترقيم تسلسلي سنوي لكل مصنع: INV-2026-0001
 * يُحسب داخل معاملة قابلة للتسلسل لمنع تكرار الأرقام عند الطلبات المتزامنة.
 */
...
/** GET /api/invoices — قائمة فواتير المصنع */
...
/** POST /api/invoices — توليد فاتورة من عرض سعر معتمد (ESTIMATOR فأعلى) */
...
/** PATCH /api/invoices — تحديث حالة السداد (MANAGER فأعلى) */
