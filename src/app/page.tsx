    ...
    <main className="min-h-screen bg-slate-50 dark:bg-slate-950">
      <div className="max-w-5xl mx-auto px-6 py-20">
        ...
        <div className="flex flex-wrap gap-3 mt-8">
          <Link href="/register" className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-semibold shadow-md shadow-blue-600/20 transition">
            سجّل مصنعك مجاناً <ArrowLeft size={18} />
          </Link>
          <Link href="/login" className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-200 px-6 py-3 rounded-xl font-semibold transition">
            تسجيل الدخول
          </Link>
        </div>
